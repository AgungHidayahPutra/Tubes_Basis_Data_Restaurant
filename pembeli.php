...
if (isset($_POST['bdeleteall'])) {
    // hapus semua data
    $hapus_all = mysqli_query($koneksi, "DELETE FROM pembeli");
...
if (isset($_POST['bsimpan'])) {
    ...
    // Cek data kosong
    if (empty($_POST['tid_pembeli']) || empty($_POST['tnama']) || $_POST['tjns_kelamin'] == "" || empty($_POST['talamat']) || empty($_POST['tno_hp'])) {
        echo "<script>
    ...
    if (isset($_GET['hal']) == "edit") {
        ...
        $simpan = mysqli_query($koneksi, "  INSERT INTO pembeli (id_pembeli, nama, jns_kelamin, alamat, no_hp)
...
<body>
    ...
    <nav>
        ...
        <a href="pembeli.php"><label class="logo" style="font-family: Agbalumo;">AFFA Resto</label></a>
        <ul class="nav-links">
            <li><a href="pembeli.php" class="link-nav active">Pembeli</a></li>
                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="mb-1">
                                ...
                                <h5>Nama Pembeli</h5>
                                <input type="text" name="tnama" value="<?= $vnama ?>" class="form-control" placeholder="Masukkan Nama Pembeli">
                            </div>

                            <div class="mb-1">
                                <label class="form-label">Alamat Pembeli</label>
                                <h5>Alamat Pembeli</h5>
                                <input type="text" name="talamat" value="<?= $valamat ?>" class="form-control" placeholder="Masukkan Alamat Pembeli">
                            </div>
                ...
                <div class="table-content">
                    <table class="table table-hover">
                        ...
                        if (isset($_POST['bcari'])) {
                            ...
                            $keyword = $_POST['tcari'];
                            $q = "SELECT * FROM pembeli WHERE id_pembeli like '%$keyword%' or nama like '%$keyword%' or jns_kelamin like '%$keyword%' 
                        or alamat like '%$keyword%' or no_hp like '%$keyword%' order by id_pembeli asc";
                        } else {
                            $q = "SELECT * FROM pembeli order by id_pembeli asc";
                        }
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><?= $data['no_hp'] ?></td>
                                <td>
                                    <a href="pembeli.php?hal=edit&id=<?= $data['id_pembeli'] ?>" class="btn btn-warning">Edit</a>

                                    <a href="pembeli.php?hal=delete&id=<?= $data['id_pembeli'] ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan hapus data ini')">Delete</a>
                                </td>
                            </tr>
